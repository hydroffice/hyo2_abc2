...
#
# python /path/to/pyinstaller.py --clean -y ABC.spec
#
...
from hyo2.abc2 import __version__ as abc_version
...
pyside2_data = collect_pkg_data('PySide6')
...
a = Analysis(['ABC.py'],
             pathex=[],
             hiddenimports=["PIL", "scipy._lib.messagestream", "PySide6.QtPrintSupport", "pyproj.datadir"],
