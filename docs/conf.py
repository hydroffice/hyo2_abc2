...
htmlhelp_basename = 'HydrOfficeABCDoc'
...
man_pages = [
    ('index', 'hydrofficeabc', u'HydrOffice ABC Documentation',
...
texinfo_documents = [
  ('index', 'HydrOfficeABC', u'ABC',
   u'University of New Hampshire, Center for Coastal and Ocean Mapping',
   'HydrOfficeABC', 'Common elements for HydrOffice libraries and applications.',
   'Miscellaneous'),
]
